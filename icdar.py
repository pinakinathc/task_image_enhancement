...
tf.app.flags.DEFINE_string('training_data_path', '../training_data/night_images',
...
def generator(input_size=512, batch_size=32,
              ...
              vis=False, image_path=FLAGS.training_data_path, validation=False):
        ...
        for i in index:
            try:
                ...
                if vis:
                    ...
                    axs[1, 1].set_xticks([])
                    axs[1, 1].set_yticks([])
                    axs[2, 0].imshow(im_padded_enhanc)
                ...
                all_text_polys.append(text_polys)
